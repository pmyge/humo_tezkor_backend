...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ('telegram_user_id', 'first_name', 'phone_number', 'created_at')
    list_filter = ('created_at',)
    search_fields = ('telegram_user_id', 'first_name', 'phone_number', 'username')
    ...
    fieldsets = (
        ('Telegram Info', {
            'fields': ('telegram_user_id', 'username', 'first_name')
        }),
        ('Contact', {
            'fields': ('phone_number',)
        }),
